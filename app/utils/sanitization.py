...
def sanitize_for_logging(
    text: str, max_length: int = MAX_LOG_DESCRIPTION_LENGTH, redact: bool = False
) -> str:
...
def validate_description_length(description: str, max_bytes: int) -> tuple[bool, Optional[str]]:
