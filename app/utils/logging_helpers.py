...
def log_job_transition(
    logger: logging.Logger, job_id: str, from_status: Optional[str], to_status: str, **extra_fields
):
    ...
    """
    context = create_structured_log_context(
        job_id=job_id, from_status=from_status, to_status=to_status, **extra_fields
    )
