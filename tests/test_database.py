...
from app.services.db.connection import close_db_engine, get_db_engine, test_connection
...
class TestDatabaseConfiguration:
    ...
    def test_database_user_required_when_constructing_url(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            Settings(database_password="pass", database_host="localhost")
    ...
    def test_database_password_required_when_constructing_url(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            Settings(database_user="user", database_host="localhost")
    ...
    def test_empty_database_user_rejected(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            Settings(database_user="   ", database_password="pass")
    ...
    def test_empty_database_password_rejected(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            Settings(database_user="user", database_password="   ")
    ...
    def test_database_port_validation_range(self):
        ...
        # Valid port
        settings = Settings(database_user="user", database_password="pass", database_port=8080)
        assert settings.database_port == 8080

        # Port too low (0)
        with pytest.raises(ValidationError):
            Settings(database_user="user", database_password="pass", database_port=0)

        # Port too high
        with pytest.raises(ValidationError):
            Settings(database_user="user", database_password="pass", database_port=70000)
    ...
    def test_default_database_settings(self):
        ...
        settings = Settings(database_user="user", database_password="pass")
...
class TestDatabaseConnection:
    ...
    def test_get_db_engine_creates_engine(self):
        ...
        engine = get_db_engine(database_url="postgresql+asyncpg://test:test@localhost:5432/testdb")
    ...
    def test_get_db_engine_returns_singleton(self):
        ...
        engine1 = get_db_engine(database_url="postgresql+asyncpg://test:test@localhost:5432/testdb")
