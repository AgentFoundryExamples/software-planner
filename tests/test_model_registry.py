...
def test_model_config_defaults():
    ...
    config = ModelConfig(
        provider="anthropic", model_id="claude-sonnet-4.5", api_key_env="ANTHROPIC_API_KEY"
    )
...
def test_model_config_invalid_timeout():
    ...
    with pytest.raises(ValidationError):
        ModelConfig(provider="openai", model_id="gpt-5.1", api_key_env="OPENAI_API_KEY", timeout=0)
...
def test_model_config_negative_retries():
    ...
    with pytest.raises(ValidationError):
        ModelConfig(
            provider="openai", model_id="gpt-5.1", api_key_env="OPENAI_API_KEY", max_retries=-1
        )
...
def test_model_registry_get_model_config():
    ...
    test_registry = {
        "gpt5": ModelConfig(provider="openai", model_id="gpt-5.1", api_key_env="OPENAI_API_KEY")
    }
...
def test_model_registry_get_enabled_models():
    ...
    test_registry = {
        "gpt5": ModelConfig(
            provider="openai", model_id="gpt-5.1", api_key_env="OPENAI_API_KEY", enabled=True
        ),
        "claude": ModelConfig(
            provider="anthropic",
            model_id="claude-sonnet-4.5",
...
def test_model_registry_get_models_by_provider():
    ...
    test_registry = {
        "gpt5": ModelConfig(provider="openai", model_id="gpt-5.1", api_key_env="OPENAI_API_KEY"),
        "gpt4": ModelConfig(provider="openai", model_id="gpt-4", api_key_env="OPENAI_API_KEY"),
        "claude": ModelConfig(
            provider="anthropic", model_id="claude-sonnet-4.5", api_key_env="ANTHROPIC_API_KEY"
        ),
    }
